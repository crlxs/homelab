...
+--------------+-------------------------+---------+-------------+----------------+----------------+
| r620         | DELL PowerEdge R620     | idrac   | N/A         | 172.17.0.2     | gs1920 P19     |
...
+==============+=========================+=========+================+
| servarr      | PVE Debian 13 VM        | eth0    | 172.17.0.100   |
+--------------+-------------------------+---------+----------------+
| sabnzbd      | PVE Debian 13 VM        | eth0    | 172.17.0.200   |
+--------------+-------------------------+---------+----------------+
| jellyfin     | PVE Debian 13 VM        | eth0    | 172.17.0.101   |
+--------------+-------------------------+---------+----------------+
| syncthing    | PVE Debian 13 VM        | eth0    | 172.17.0.50    |
+--------------+-------------------------+---------+----------------+
```
...
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| VAULT (NFS/SAMBA on a PVE LXC)   | LXC "vault" in proxmox                        | 172.17.1.1 TCP/2049 (NFS)                        |
...
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| homarr                           | container "homarr" in rpi                     | 192.168.1.100 TCP/7575 (Web portal)              |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| prowlarr                         | container "prowlarr" in VM "servarr"          | 172.17.0.100 TCP/9696 (Web portal)               |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| radarr                           | container "radarr" in VM "servarr"            | 172.17.0.100 TCP/7878 (Web portal)               |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| sonarr                           | container "sonarr" in VM "servarr"            | 172.17.0.100 TCP/8989 (Web portal)               |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| jellyseerr                       | container "jellyseerr" in VM "servarr"        | 172.17.0.100 TCP/5055 (Web portal)               |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| jellyfin                         | VM "jellyfin"                                 | 172.17.0.101 TCP/5055 (Web portal)               |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
| syncthing                        | container "syncthing" in VM "syncthing"       | 172.17.0.50 TCP/8384 (Web portal)                |
+----------------------------------+-----------------------------------------------+--------------------------------------------------+
```
